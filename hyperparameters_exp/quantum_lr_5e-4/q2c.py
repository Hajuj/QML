...
class A2C(object):
    def __init__(self, observation_space, action_space):
        ...
        # optimize actor
        self.actor_optimizer = torch.optim.Adam(self.actor.parameters(), lr=self.quantum_lr)
...
if __name__ == '__main__':
    ...
    for seed in range(7):
        ...
        file_name = "Q2C_4_r.csv".split(".")[0] + "_{}".format(seed) + '_' + datetime.datetime.now().strftime("%d.%m.%Y_%H-%M-%S") + ".csv"
