...
def qnode(inputs, weights):
    ...
    return [qml.expval(qml.PauliZ(i)) for i in range(1)]  # measure
...
class A2C(object):
    def __init__(self, observation_space, action_space):
        ...
        self.quantum_lr = 5e-4  # learning rate 0.0005
        ...
        # optimize critic
        self.critic_optimizer = torch.optim.Adam(self.critic.parameters(), lr=self.quantum_lr)
    ...
    def train(self, env, max_episodes):
        ...
        while episodes < max_episodes:
            ...
            # add stats
            stats.append([episodes, total_score, env_name, max_episodes, self.lr, self.quantum_lr, self.gamma,
            ...
            with open(os.path.join(directory, file_name), 'w') as f:
                writer = csv.writer(f)
                writer.writerow(
                    ['Episode', 'Episode Score', 'Environment', 'Max Episodes', 'Learning Rate', 'Quantum Learning Rate', 'Gamma',
                     'Hidden Layers', 'Seed'])
...
if __name__ == '__main__':
    ...
    for seed in range(7):
        ...
        file_name = "A2Q_4_r.csv".split(".")[0] + "_{}".format(seed) + '_' + datetime.datetime.now().strftime("%d.%m.%Y_%H-%M-%S") + ".csv"
